"""
AURORA Google Maps API Integration - Simple Version
...
class AURORAGoggleMapsAPISimple:
...
if __name__ == "__main__":
    create_aurora_google_maps_simple() 