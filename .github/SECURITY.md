...
AURORA is research software and does not expose a network service or process untrusted executable model files. Security reports should not include secrets or sensitive personal data in a public issue.
